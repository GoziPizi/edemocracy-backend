...
LoginRouter.post(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const checkoutUrl = await AuthentificationService.preRegisterStandard(
        userInput as StandardUserCreateInputDto,
        recto1,
        verso1,
        recto2,
        verso2,
...
LoginRouter.post(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const checkoutUrl = await AuthentificationService.preRegisterPremium(
        userInput,
        recto1,
        verso1,
        recto2,
